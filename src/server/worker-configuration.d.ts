// Generated by Wrangler by running `wrangler types ./src/server/worker-configuration.d.ts` (hash: f2d08345cdf829b671cfb3cbdf044e8f)
// Runtime types generated with workerd@1.20250321.0 2025-04-01 
declare namespace Cloudflare {
	interface Env {
		Chat: DurableObjectNamespace<import("./index").Chat>;
		ASSETS: Fetcher;
		ADMIN_STATE_DO: DurableObjectNamespace;
	}
}
